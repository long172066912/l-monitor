...
public class LCountedAspect {
     ...
     */
    public LCountedAspect(MeterRegistry registry) {
     ...
     */
    public LCountedAspect(MeterRegistry registry, Function<ProceedingJoinPoint, Iterable<Tag>> tagsBasedOnJoinPoint) {
     ...
     * @since 1.7.0
     */
    public LCountedAspect(MeterRegistry registry, Predicate<ProceedingJoinPoint> shouldSkip) {
        this(
                registry,
     ...
     * @since 1.7.0
     */
    public LCountedAspect(MeterRegistry registry, Function<ProceedingJoinPoint, Iterable<Tag>> tagsBasedOnJoinPoint, Predicate<ProceedingJoinPoint> shouldSkip) {
