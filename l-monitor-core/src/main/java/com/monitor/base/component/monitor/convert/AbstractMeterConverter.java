 ...
 */
public abstract class AbstractMeterConverter<T extends Meter> implements MeterConverter<T, LMonitorStatisticsData>, MeterConvertFunction<T, LMonitorStatisticsData> {
    /**
     * 需要排除的tags
     */
     ...
     * 所有监控指标默认前缀
     */
    public static final String METER_PREFIX = "l-monitor-";
    ...
    @Override
    public LMonitorStatisticsData convert(T meter, long timestamp) {
