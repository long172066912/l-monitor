...
public class WbTimedAspect {
     ...
     */
    public WbTimedAspect(MeterRegistry registry) {
     ...
     */
    public WbTimedAspect(MeterRegistry registry, Function<ProceedingJoinPoint, Iterable<Tag>> tagsBasedOnJoinPoint) {
     ...
     * @since 1.7.0
     */
    public WbTimedAspect(MeterRegistry registry, Predicate<ProceedingJoinPoint> shouldSkip) {
        this(
                registry,
     ...
     * @since 1.7.0
     */
    public WbTimedAspect(MeterRegistry registry, Function<ProceedingJoinPoint, Iterable<Tag>> tagsBasedOnJoinPoint, Predicate<ProceedingJoinPoint> shouldSkip) {
